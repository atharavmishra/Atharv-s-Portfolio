...
export default function Home() {
  ...
  const handleRedirectQQ = () => {
    window.open('https://quickq.codesh.in/store?handles=2Rd9w69dG6aLmeEsBz6b', '_blank');
  };
          ...
          <div className="text-center md:p-10 md:py-10">
            ...
            <div className="w-full p-6 mt-10 shadow-2xl rounded-xl overflow-hidden bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 dark:from-gray-800 dark:via-gray-900 dark:to-black text-white transform transition-all duration-500 hover:scale-105">
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  <span className="text-2xl">⏰</span>
                  <p>working on<a className="text-purple-300">Restaurant automation application</a></p>
                </div>
                <div className="flex items-center space-x-4">
        ...
        <section>
          ...
          <div className="lg:flex gap-5">
            <div className="text-start md:p-10 rounded-xl mt-10 flex-1 flex flex-wrap" style={{ height: 'auto' }}>
              ...
              <div className=" w-full p-6 mx-auto mt-10 shadow-2xl rounded-xl overflow-hidden bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 dark:from-gray-800 dark:via-gray-900 dark:to-black text-gray-100 dark:text-gray-200 transform transition-all duration-500 hover:scale-105">
                <h3 className="text-4xl py-2 text-gray-300 font-medium dark:text-gray-400 md:text-4xl">
                  Self-Checkout Kiosk App – Wonderla
                </h3>
                <p className="py-2 text-white">
                  Developed a self-checkout kiosk app for Wonderla, enabling guests to order food and items independently with digital payments, reducing queue times and improving operational efficiency.                </p>
                <div className="flex justify-center mt-6">
                  {/* <a
                    className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 border-none rounded-md"
                    href="#"
          ...
          {/* <div className="lg:flex gap-5">
            <div className="text-start md:p-10 rounded-xl mt-10 flex-1 flex flex-wrap" style={{ height: 'auto' }}>
              <div className="w-full lg:w-1/3 p-2">
                <div className="shadow-2xl rounded-lg overflow-hidden bg-white dark:bg-gray-800 transition-transform transform hover:scale-105 hover:shadow-xl" style={{ width: '100%', position: 'relative' }}>
                  <Image src={qq_3} layout="responsive" objectFit="cover" />
                </div>
              </div>

              <div className="w-full lg:w-1/3 p-2">
                <div className="shadow-2xl rounded-lg overflow-hidden bg-white dark:bg-gray-800 transition-transform transform hover:scale-105 hover:shadow-xl" style={{ width: '100%', position: 'relative',}}>
                  <Image src={qq_1} layout="responsive" objectFit="cover" />
                </div>
              </div>
              <div className="w-full lg:w-1/3 p-2">
                <div className="shadow-2xl rounded-lg overflow-hidden bg-white dark:bg-gray-800 transition-transform transform hover:scale-105 hover:shadow-xl," style={{ width: '88%', position: 'relative', padding: '20px' , paddingTop: '40px', height: '100%'}}>
                  <Image src={qq_2} layout="responsive" objectFit="cover" />
                </div>
              </div>
              <div className=" w-full p-6 mx-auto mt-10 shadow-2xl rounded-xl overflow-hidden bg-gradient-to-br from-purple-600 via-pink-500 to-red-500 dark:from-gray-800 dark:via-gray-900 dark:to-black text-gray-100 dark:text-gray-200 transform transition-all duration-500 hover:scale-105">
                <h3 className="text-4xl py-2 text-gray-300 font-medium dark:text-gray-400 md:text-4xl">
                ...
                <p className="py-2 text-white">
                 QR-based self-ordering system for dine-in restaurants. Customers scan table QR codes to access the menu, place orders, and pay. The system also allows for table management, order tracking, and payment collection.
                </p>
                <div className="flex justify-center mt-6">
                  <a
                    className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 border-none rounded-md"
                    href="#"
                    onClick={handleRedirectQQ}
                  >
                    Live App
                  </a>
                </div>
